...
export default function LandingPageDescription({ title, description, href, buttonTitle, variant = 'left' }: { title?: string, description?: string, href?: string, buttonTitle?: string, variant?: string }) {
    ...
    return(
        <div className="sm:w-1/2 flex items-center">
            ...
            <div className="flex flex-col px-5 sm:px-10 md:px-15 lg:px-20 2xl:px-25 gap-5 xl:gap-10 2xl:gap-15 -mb-10">
                <h2 className="text-xl sm:text-lg md:text-xl lg:text-2xl 5xl:text-4xl font-regular sm:font-thin italic absolute top-10 right-0 sm:static z-10 text-white sm:text-black">{title}</h2>
